...
Reference(s)
    See equation 6.24 (page 144) and equation 6.25 (page 144) in Nocedal and Wright's 'Numerical Optimization' (2nd Ed) for the Hessian approximation and inverse Hessian approximation respectively. 
