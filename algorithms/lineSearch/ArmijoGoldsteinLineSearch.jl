module ArimjoGoldsteinLineSearchModule
    ...
    export ArmijoGoldsteinBTLineSearch
    """
    ...
    Reference(s)
        ...
        The Armijo condition can be found in equation 3.4 in the same text (pg 33). The Goldsteiin Condition can be found
    ...
    """
    struct ArmijoGoldsteinBTLineSearch <: LineSearchMethod
        c1::Float64
        rho::Float64

        # default constructor
        ArmijoGoldsteinBTLineSearch(;c1 = 1e-4, rho = 0.5) = new(c1, rho)
    end
    ...
    function stepSearch(parameters::ArmijoLineSearchBt, 
        ...
        error("Armijo-Goldstein backtracking failed: maximum iterations ($lineSearchLim) reached")
    end
